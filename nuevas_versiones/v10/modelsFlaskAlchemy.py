...
class EstadoRobot(db.Model):
    __tablename__ = 'estado_robot'

    id = db.Column(db.Integer, primary_key=True, autoincrement=True)
    timestamp = db.Column(db.DateTime, default=datetime.utcnow, nullable=False)
    small_pieces = db.Column(db.Integer, nullable=False)
    large_pieces = db.Column(db.Integer, nullable=False)
    belt_status = db.Column(db.String(15), nullable=False)
    belt_speed = db.Column(db.Integer, nullable=False)
    gripper_status = db.Column(db.String(15), nullable=False)
    sensor_DI1 = db.Column(db.String(5), nullable=False)
    sensor_DI5 = db.Column(db.String(5), nullable=False)
    pose = db.Column(db.Text, nullable=False)
